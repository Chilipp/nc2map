...
from numpy import ravel, reshape, array, append
...
def wrap_subplot(_instance, _num, _shape, *args, **kwargs):
    ...
    Input:
      - _instance: Any instance (e.g. a subplot created with plt.subplots)
      - num: Number of the subplot in the plot (e.g. for
          plt.reset_geometry(x, y, num))
      - shape: Shape of the subplots (e.g. from plt.subplots(x, y))
    Returns:
      - AxesWrapper instance being an instance of _instance.__class__
    """
